<template>
  ...
  >
    <h1 class="text-4xl font-bold mb-4 text-custom">Order ID: {{ orderId }}</h1>
    <p class="text-lg text-center text-description">
      Silakan ke kasir untuk melakukan konfirmasi pesanan Anda. :3
    </p>
  </div>
  <div class="absolute top-5 right-5">
    <router-link to="/home" class="bg-description text-custom px-4 py-2 rounded"
      >Home</router-link
    >
  </div>
</template>
